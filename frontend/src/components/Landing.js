        ...
        <div>
            ...
            <Container className="notice">
                        <h3>Important Notice</h3>
                            ...
                            <p>NOTE: Website still in the making, basic functionalities work but UI, code readability, and organization needs work.</p>
                                                        <p>Recruiters may request a temporary email and password. However, please be aware that all files uploaded will be visible to the developer.</p>
                                                        <p>NOTE: Website still in the making, basic functionalities work but UI, code readability, and organization needs work.</p>                            <p>Recruiters may request a temporary email and password. However, please be aware that all files uploaded will be visible to the developer.</p>
                                                                                                                                                                                                               <p>NOTE: Website still in the making, basic functionalities work but UI, code readability, and organization needs work.</p>                            <p>Recruiters may request a temporary email and password. However, please be aware that all files uploaded will be visible to the developer.</p>
                                                                                                                                                                                                                                                                                                                                                                      <p>NOTE: Website still in the making, basic functionalities work but UI, code readability, and organization needs work.</p>                            <p>Recruiters may request a temporary email and password. However, please be aware that all files uploaded will be visible to the developer.</p>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             <p>NOTE: Website still in the making, basic functionalities work but UI, code readability, and organization needs work.</p>                            <p>Recruiters may request a temporary email and password. However, please be aware that all files uploaded will be visible to the developer.</p>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <p>NOTE: Website still in the making, basic functionalities work but UI, code readability, and organization needs work.</p>                            <p>Recruiters may request a temporary email and password. However, please be aware that all files uploaded will be visible to the developer.</p>
